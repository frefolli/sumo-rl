...
class PPOAgent(Agent):
  ...
  def __init__(self, id: str,
    ...
    self.model: PPO = PPO('MlpPolicy', self.dummy_env, verbose=1, batch_size=512)
  ...
  def learn(self, rewards: dict[str, typing.Any]):
    ...
    for ID in self.controlled_entities.keys():
      ...
      self.model.rollout_buffer.add(obs=previous_state, action=previous_action, reward=reward, episode_start=False, value=value.detach(), log_prob=log_prob.detach())
