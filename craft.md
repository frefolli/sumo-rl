...
Nell'**addestramento** utilizzo solo la categoria **Normalita'** in tutte le varieta' Stabili (baseline), Instabili, Casuali e Transizioni (fine-tuning).

Le altre categorie (**Sciopero Treni**, **Sciopero TPL**, **Cantiere Tram**) le uso nella **valutazione**.
