...
- [x] Controlla la sezione su “code artificiali” nella tesi di Michelucci (cap. 4.2), eventualmente ipotizza un meccanismo alternativo
- [x] Stabilizza l’ambiente di esempio, stabilisci degli scenari di test standard (e.g. traffico feriale di punta periferia —> centro, traffico feriale di punta centro —> periferia, traffico festivo, traffico anomalo (sciopero dei mezzi)
- [x] Implementare PPO
- [x] Implementa la creazione semi-automatica della collezione di esempi
- [x] Stabilisci quali sono scenari di addestramento e quali di valutazione
...
![Breda.png](https://res.craft.do/user/full/d7b7d2cb-207e-82b6-9963-2eada2eeca31/doc/28711EF5-4446-475D-8A23-FBEC32918F27/c3ed0caf-9c7f-4b9e-83a5-2d3500b98625)
